...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_nameuser = headerView.findViewById(R.id.tv_nameuser);

        Log.d(TAG, "onCreate: " + Common.currUser.getName());
        tv_nameuser.setText(Common.currUser.getName());
        ...
        adapter =
                new FirebaseRecyclerAdapter<Category, MenuViewHolder>(Category.class, R.layout.menu_item, MenuViewHolder.class, category) {
                    ...
                    protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                        viewHolder.tv_menuName.setText(model.getName());
    ...
    private void setUpUI() {
        ...
        recycler_menu = findViewById(R.id.rv_menu);
